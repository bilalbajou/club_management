        ...
        ssrRenderList(__props.links, (link, k) => {
          ...
          if (link.url === null) {
            ...
            _push(ssrRenderComponent(unref(Link), {
              "preserve-scroll": "",
              "preserve-state": "",
              data: { search: __props.search, type: _ctx.type, equipe: __props.equipe },
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Salaire/Components/Pagination.vue");
