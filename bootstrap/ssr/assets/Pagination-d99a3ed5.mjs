        ...
        ssrRenderList(__props.links, (link, k) => {
          ...
          if (link.url === null) {
            ...
            _push(ssrRenderComponent(unref(Link), {
              "preserve-scroll": "",
              "preserve-state": "",
              data: { search: __props.search, poste: __props.poste, equipe: __props.equipe },
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Joueur/Components/Pagination.vue");
